...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,title,body,createdAt,updatedAt,isPrivate,const DeepCollectionEquality().hash(tags));

@override
String toString() {
  return 'Diary(id: $id, userId: $userId, title: $title, body: $body, createdAt: $createdAt, updatedAt: $updatedAt, isPrivate: $isPrivate, tags: $tags)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,title,body,createdAt,updatedAt,isPrivate,const DeepCollectionEquality().hash(_tags));
